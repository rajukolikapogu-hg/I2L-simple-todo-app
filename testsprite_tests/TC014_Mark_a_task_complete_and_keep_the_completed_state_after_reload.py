...
async def run_test():
    ...
    try:
        ...
        # -> Fill 'Complete me' into the Task field, set a due date, and click the 'Add task' button to create the task.
        # What needs doing? text field
        elem = page.locator('[id="task-title"]')
        await elem.wait_for(state="visible", timeout=10000)
        await elem.fill("Complete me")
        ...
        # -> Click the 'Mark "Complete me" as complete' checkbox to mark the task complete, then reload the page to verify persistence.
        # Mark "Complete me" as complete checkbox
        elem = page.get_by_label('Mark "Complete me" as complete', exact=True)
        await elem.click(timeout=10000)
        ...
        # --> The 'Complete me' task remains checked after the page reload.
